...
class ArcNet(nn.Module):
    def __init__(self,
        ...
        self.class_dim = class_dim #类别数量
        self.margin = margin #margin
        self.scale = scale #缩放大小
        self.easy_margin = easy_margin
        self.weight = Parameter(torch.FloatTensor(feature_dim, class_dim)) #张量:feature_dim * class_dim
        nn.init.xavier_uniform_(self.weight) #张量初始化
